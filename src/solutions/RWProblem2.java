...
public class RWProblem2 extends AbstractRWProblem {
	// ______________________________ MAIN __________________________
	public static void main(String[] args) {
		Process.setSynchronisationWrapper(new RWProblem2());
